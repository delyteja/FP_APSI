...
<html lang="en">
  <head>
	...
	<!-- {{ URL::asset('assets/js/modernizr.custom.js') }} -->
      ...
      <div class="container">
        <div class="navbar-header">
          <button type="button" class="navbar-toggle" data-toggle="collapse" data-target=".navbar-collapse">
            <span class="icon icon-shield" style="font-size:50px; color:#3498db;"></span>
          </button>
        ...
        <div class="navbar-collapse collapse">
          <ul class="nav navbar-nav">
			...
			<li> <a href="#services" class="smoothScroll">Mentor</a></li>
			<li> <a href="#team" class="smoothScroll"> Testimoni</a></li>
			<li> <a href="#contact" class="smoothScroll"> Contact</a></li>
			<li style="margin-left: 540px;"><a href="{{ route('register')}}" class="smoothScroll">Register</a></li>
  ...
  <a href="{{ route('register') }}">Register</a>
   -->
		...
		<div id="greywrap">
			<div class="row">
				<div class="col-lg-4 callout">
					...
					<h2>Mudah</h2>
					<p>Dengan mengikuti kursus di Rasyid Course Anda dapat dengan mudah medapatkan materi materi pembelajaran yangtidak didapatkan di sekolah</p>
				</div><!-- col-lg-4 -->
					
				<div class="col-lg-4 callout">
					<span class="icon icon-eye"></span>
					<h2>Fleksibel</h2>
					<p>Dengan mengikuti kursus di Rasyid Course Anda dapat belajar kapanpun dan dimanapun </p>
				</div><!-- col-lg-4 -->	
				
				<div class="col-lg-4 callout">
					<span class="icon icon-heart"></span>
					<h2>Bermanfaat</h2>
					<p>Telah banyak alumni Rasyid Course menyatakan bahwa mengikuti kursus di rasyid Course sangat bermanfaat   </p>
				</div><!-- col-lg-4 -->	
			</div><!-- row -->
		</div><!-- greywrap -->
		...
		<div class="container" id="about" name="about">
			<div class="row white">
			<br>
				<h1 class="centered">Sekilas Tentang Rasyid Course</h1>
				<hr>
		...
		<div class="container" id="services" name="services">
			...
			<br>
			<div class="row">
				<h2 class="centered">Tentang Mentor Pengajar di Rasyid Course</h2>
				<hr>
				<br>
		...
		<br>
			<div class="row white centered">
				<h1 class="centered">Testimoni</h1>
				<hr>
				<br>
				<br>
		...
		<div class="container" id="contact" name="contact">
			<div class="row">
			<br>
				<h1 class="centered">KONTAK</h1>
				<hr>
				<br>
				<br>
				<div class="col-lg-4">
					<h3>Contact Information</h3>
					<p><span class="icon icon-home"></span> Perumahan BME Nomor 13<br/>
						<span class="icon icon-phone"></span> +62 9884 4893 <br/>
						<span class="icon icon-mobile"></span> +62 59855 9853 <br/>
						<span class="icon icon-envelop"></span> <a href="#"> info@rasyid.com</a> <br/>
						<span class="icon icon-twitter"></span> <a href="#"> @Rasyid_info </a> <br/>
					</p>
				</div><!-- col -->
		...
		<div id="footerwrap">
			<div class="container">
				<h4>Created by <a href="http://blacktie.co">Rasyid course. com</a>-Copyright 2017</h4>
			</div>
		</div>
